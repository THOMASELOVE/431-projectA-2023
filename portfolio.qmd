...
You will submit a polished report in both Quarto and HTML, incorporating a total of 17 sections, as described below. You will also submit your main data file (`chr_2023_YOURNAME.Rds`). 
...
Once you have submitted the other two elements of your project, you will each (whether working alone or with a partner) submit [a brief self-evaluation via this Google Form](https://bit.ly/431-projectA-self-evaluation-2023). The form should take about 10 minutes to complete.
...
All portfolio elements (R data set, Quarto and HTML report, video and self-evaluation) are due in late October at the time and date indicated on the [Course Calendar](https://thomaselove.github.io/431-2023/calendar.html). 
...
- Everyone (including both members of each team) should fill out [the self-evaluation form](https://bit.ly/431-projectA-self-evaluation-2023) **after** all other materials are posted to Canvas.

# Outline of the Portfolio Report

Your final portfolio report will include:

- Sections 1-12 from the [Proposal](proposal.qmd), edited as necessary.
...
Section 17 was completed as part of the proposal, although there it was Section 14.

So, if you've completed (and edited) your [proposal](proposal.qmd), and completed your [analyses](analyses.qmd) sections, then the only new piece of the Proposal Report is the new "reflections" section.
...
1. There is a meaningful title (of no more than 80 characters, perhaps augmented by a subtitle), set of authors (with full names) and date (in the format 2023-10-31) at the top of your HTML document. Use CHR-2023 as an abbreviation for "County Health Rankings, 2023" throughout your work.
...
- A successful Proposal is a mandatory part of Project A, and is worth 20 points as part of the Project A grade. 
- The Report is worth 40 points. It is unlikely that anyone will score above 38 points, which is the planned score for a completely accurate and polished report. Most scores will likely fall between 29 and 36 points on this element.
    ...
    - Most of the feedback you will receive on your Project A report will relate to specific grading criteria that will be evaluated (mostly) by the teaching assistants. 
