...
Use the instructions in [Data Task 5](data.qmd) to include the 2018 version of your Analysis 3 outcome as a variable in your tibble. This should give you a total of 11 variables.

## Section 8. Arranging and Saving The Analytic Tibble

After renaming your variables, arrange the 11 variables in your **chr_2023** tibble into the order specified in [Data Task 6](data.qmd).
...
After you select your variables, use the [County Health Rankings website's 2023 Measures list](https://www.countyhealthrankings.org/explore-health-rankings/county-health-rankings-measures), and in particular the linked information on that page for full descriptions, definitions and limitations of the variables you have selected. 
